-- Chat Flow V2 - Simple Create Script
-- This script creates a fresh chat_flow table with individual INSERT statements
...
-- Insert data with individual INSERT statements
...
INSERT INTO public.chat_flow (step_number, block, question_text, question_icon, question_type) VALUES
(102, 'INTRO', 'Perfekt! Resultatrapport och balansräkning är nu skapad från SE-filen.', '✅', 'message');

INSERT INTO public.chat_flow (step_number, block, question_text, question_icon, question_type) VALUES
(103, 'INTRO', 'Årets resultat är: {SumAretsResultat}. Se fullständig resultat- och balans rapport i preview fönstret till höger.', '💰', 'message');
...
INSERT INTO public.chat_flow (step_number, block, question_text, question_icon, question_type) VALUES
(202, 'PENSION', 'Perfekt, nu är den särskilda löneskatten justerad som du kan se i skatteuträkningen till höger.', '✅', 'message');
...
(303, 'UNDERSKOTT', 'Outnyttjat underskott från föregående år har blivit uppdaterat med {unusedTaxLossAmount} kr, som du kan se i skatteuträkningen till höger.', '✅', 'options', 'Ja, gå vidare', 'continue', 401, 'api_call', '{"endpoint": "recalculate_ink2", "params": {"ink4_14a_outnyttjat_underskott": "{unusedTaxLossAmount}"}}');
...
INSERT INTO public.chat_flow (step_number, block, question_text, question_icon, question_type) VALUES
(405, 'SLUTSKATT', 'Perfekt! Nu är årets skatt beräknat och vi har även ett slutgiltigt årets resultat och vi kan gå vidare!', '✅', 'message');
...
INSERT INTO public.chat_flow (step_number, block, question_text, question_icon, question_type) VALUES
(505, 'UTDELNING', 'Perfekt! Då har vi bestämt hur utdelningsbara medel ska disponeras och kan gå vidare med att färdigställa förvaltningsberättelsen.', '✅', 'message');
